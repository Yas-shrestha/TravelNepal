...
return [
    ...
    */
    ...
    |---------------------------------------------------------------------------
    |
    | Root namespace Livewire checks before resolving Volt / single-file views.
    | This must not map to Composer PSR-4 autoload (e.g. App\\), or missing
    | legacy files under App\\Livewire will throw during class_exists probes.
    |
    */

    'class_namespace' => 'LivewireVolt',
    ...
    |---------------------------------------------------------------------------
    |
    | Used by make:livewire when generating class-based components.
    |
    */

    'class_path' => app_path('LivewireVolt'),
