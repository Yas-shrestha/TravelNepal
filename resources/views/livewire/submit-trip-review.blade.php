        ...
        <form wire:submit="submit" class="space-y-4">
            <div class="grid gap-4 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" wire:model="name" class="w-full rounded-xl border border-[#1a3a2a]/20 bg-white px-4 py-3 text-sm" />
                    @error('name')
                ...
                <div>
                    ...
                    <input type="email" wire:model="email" class="w-full rounded-xl border border-[#1a3a2a]/20 bg-white px-4 py-3 text-sm" />
                    @error('email')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" wire:model="location" class="w-full rounded-xl border border-[#1a3a2a]/20 bg-white px-4 py-3 text-sm" />
                </div>
                <div>
            ...
            <div>
                ...
                <textarea wire:model="quote" rows="4" class="w-full rounded-xl border border-[#1a3a2a]/20 bg-white px-4 py-3 text-sm"></textarea>
                @error('quote')
                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                @enderror
            </div>
